...
pub fn defaultLog(comptime src: std.builtin.SourceLocation, comptime message_level: Level, comptime _: @TypeOf(.enum_literal), comptime format: []const u8, args: anytype) void {
